...
<div class="action-bar">
    <a href="EditContactServlet" class="action-btn">Update Contacts</a>
    <a href="DeleteContactsServlet" class="action-btn">Delete Contacts</a>
    <a href="UpdateContactsServlet" class="action-btn">Delete Profile</a>
    <a href="EditUserProfileServlet" class="action-btn">Update Profile</a>
</div>
   ...
   <form action="AddContactServlet" method="post" autocomplete="off">
     ...
     <div class="form-row">
       <label for="isfavorite">
         <input type="checkbox" name="isfavorite" id="isfavorite" value="1" />
         Mark as Favorite
       </label>
     </div>
